...
export const faqs: IFAQ[] = [
  {
    ...
    answer:
      "Priset varierar beroende på design, funktioner och omfattning. Vi erbjuder skräddarsydda lösningar baserade på dina behov. Kontakta mig för en kostnadsfri offert!",
  },
  {
