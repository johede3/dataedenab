    ...
    <section id="faq" className="py-10 lg:py-20">
      <div className="flex flex-col gap-10 lg:flex-row">
        <div>
          ...
          <SectionTitle>
            <h2 className="my-3 text-center !leading-snug lg:max-w-sm lg:text-left">Frequently Asked Questions</h2>
          </SectionTitle>
          <p className="text-foreground-accent text-center lg:mt-10 lg:text-left">Ask us anything!</p>
          <a
            href="mailto:"
